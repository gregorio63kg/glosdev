...
from gui.behaviors import DraggableResizableMixin

# Esta es la aplicación principal, el mero mero.
class GlosDEVApp(ctk.CTk, DraggableResizableMixin):
    def __init__(self):
        super().__init__()
        ...
        # Inicializar comportamientos de ventana (Mixin)
        ...
        # Configurar eventos de arrastre y menú contextual simplificado
        self.register_draggable_container(self.main_container)
